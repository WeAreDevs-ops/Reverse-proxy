...
const API_ROUTES = [
    ...
    ['/account-security-service',         'account-security-service.roblox.com'],
    ['/proof-of-work-service',            'proof-of-work-service.roblox.com'],
    ['/auth-token-service',               'auth-token-service.roblox.com'],
    ['/hba-service',                      'hba-service.roblox.com'],
    ['/rotating-client-service',          'rotating-client-service.roblox.com'],

    // Experimentation & config
    ['/product-experimentation-platform', 'product-experimentation-platform.roblox.com'],
    ['/universal-app-configuration',      'apis.roblox.com'],
    ['/guac-v2',                          'guac-v2.roblox.com'],
...
// Register API routes
for (const [prefix, target] of API_ROUTES) {
    app.use(prefix, createApiProxy(target));
}
